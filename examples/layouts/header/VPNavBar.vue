...
export default defineComponent({
  components: {
    VPNavBarTitle,
    VPNavBarAppearance: _VPNavBarAppearance,
    VPNavBarSocialLinks: _VPNavBarSocialLinks,
    VPNavBarExtra: _VPNavBarExtra,
    VPNavBarMenu: _VPNavBarMenu,
    VPNavBarHamburger: _VPNavBarHamburger,
  },
  inheritAttrs: false,
  props: {
    isScreenOpen: {
