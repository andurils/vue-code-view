...
export default {
  name: "Toolbar",
  mixins: [Locale],
  inject: ["handleShowCode", "handleChangeTransparent", "changView"],
  components: {
    MeButton,
    Tooltip,
  },
  ...
  render() {
    ...
    return (
      <div class="code-view-toolbar eqwZsr1">
